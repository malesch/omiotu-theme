      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-5 col-md-3 ">
            ...
            <span class="write-me">
              <a href="mailto:<?php echo get_option('admin_email'); ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/img/letter.png" alt="<?php echo get_option('admin_email'); ?>" >
              </a>
            </span>
            <span class="navbar-brand-text">omiotu<span class="tomi">(tOmi&nbsp;scheiderbauer)</span>.com</span>
          </div>
          ...
          <div class="col-xs-2 col-md-1">
            ...
            <a href="https://www.facebook.com/tscheiderbauer" target="_blank" class="fb">
