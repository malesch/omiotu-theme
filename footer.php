  ...
  <div class="footer">
    <div class="container">
      <div class="footer-center">
        <div class="row">
          <div class="col-xs-1 text-right">
            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/cc.png" alt="Creative Commons" />
          </div>
          <div class="col-xs-4 line-dots">
            Attribution-NonCommercial-NoDerivs 3.0 Unported (CC BY-NC-ND 3.0)
            <br />
            <span>
              <a href="https://creativecommons.org/licenses/by-nc-nd/3.0/" target="_blank">creativecommons.org/licenses/by-nc-nd/3.0/</a>
            </span>
          </div>
      ...
      <a href="https://www.facebook.com/tscheiderbauer" target="_blank" class="fb-footer">
        <img src="<?php echo get_template_directory_uri(); ?>/img/fbicon.png" alt="FB" />
      </a>
    </div> <!-- /.container -->
  </div> <!-- /.footer -->
