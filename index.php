...
<a class="collapselink visible-xs visible-sm"  data-toggle="collapse" href="#collapse<?php echo $j; ?>" aria-expanded="false" aria-controls="collapse<?php echo $j; ?>"><?php echo $category->name; ?><span class="caret"></span></a>
...
foreach ($posts as $post):
	   ...
	   $target="_self";
	   if( get_field( "link" ) && get_field( "link" )!=""): $url=get_field( "link" );$target="_blank";endif; ?>
